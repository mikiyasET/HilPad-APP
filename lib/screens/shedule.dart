    ...
    return Padding(
      ...
      child: Column(
        children:  [
          ...
          FutureBuilder<List<List<BaseModel>>>(
...
/*          ScheduleCourseTile(time: "9:00 - 11:45", detail: "CC124 Maths for Natural Science", title: "LR601",color: Colors.black,),
          ScheduleCourseTile(time: "9:00 - 11:45", detail: "CC124 Maths for Natural Science", title: "LR302",color: Colors.black,),
          ScheduleCourseTile(time: "9:00 - 11:45", detail: "Maths for Natural Science", title: "CC124",color: Colors.black,isBreak: true),
          ScheduleCourseTile(time: "9:00 - 11:45", detail: "CC124 Maths for Natural Science", title: "LR601",color: Colors.black,),
          ScheduleCourseTile(time: "9:00 - 11:45", detail: "Maths for Natural Science", title: "CC124",color: Colors.black,isBreak: true),*/
        ],
      ),
