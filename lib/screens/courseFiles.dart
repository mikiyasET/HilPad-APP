...
class CourseFilesPage extends StatelessWidget {
  ...
  var courseFilesFuture = getList(CourseFile(),subPath: "course/${Get.find<Controller>().currentCourse}").obs;
                ...
                return SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        onTap: (){
                          c.currentBatch.value = batchData[index].id.toString();
                        },
                        child: Obx(() => Container(
                          ...
                          child: Text("${batchData[index].code}",
                            style: TextStyle(
                                color: batchData[index].id.toString() == c.currentBatch.value ? Colors.white : const Color(0xff848fac),
                                fontSize: 16,
                                fontWeight: FontWeight.w400
                            ),),
                          decoration: BoxDecoration(
                              color: batchData[index].id.toString() == c.currentBatch.value ? const Color(0xff082c81) : Colors.white,
